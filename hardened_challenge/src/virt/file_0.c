...
enum _1_main_$op {
    ...
    _1_main__formal$result_STA_0$value_LIT_0 = 214,
    ...
    _1_main__IndexPI_void_star_unsigned_long2void_star$left_STA_0$result_STA_0$right_STA_1 = 108,
...
unsigned char _1_main_$array[1][182]  = { {        _1_main__constant_int$result_STA_0$value_LIT_0,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
