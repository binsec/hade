...
enum _1_main_$op {
    ...
    _1_main__Mult_int_int2int$right_STA_0$result_STA_0$left_STA_1 = 150,
    _1_main__PlusA_int_int2int$right_STA_0$result_STA_0$left_STA_1 = 137,
    _1_main__return_int$expr_STA_0 = 34,
    _1_main__convert_int2unsigned_long$left_STA_0$result_STA_0 = 214,
    ...
    _1_main__IndexPI_void_star_unsigned_long2void_star$left_STA_0$result_STA_0$right_STA_1 = 15,
    _1_main__PlusPI_void_star_unsigned_long2void_star$left_STA_0$result_STA_0$right_STA_1 = 60,
    _1_main__Eq_int_int2int$left_STA_0$result_STA_0$right_STA_1 = 254,
    _1_main__formal$result_STA_0$value_LIT_0 = 33,
    _1_main__local$result_STA_0$value_LIT_0 = 252,
    _1_main__convert_char2int$left_STA_0$result_STA_0 = 125,
    _1_main__Mult_unsigned_long_unsigned_long2unsigned_long$right_STA_0$result_STA_0$left_STA_1 = 108,
    _1_main__store_void_star$left_STA_0$right_STA_1 = 235,
    _1_main__constant_int$result_STA_0$value_LIT_0 = 7
} ;
unsigned char _1_main_$array[1][300]  = { {        _1_main__constant_int$result_STA_0$value_LIT_0,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            ...
            (unsigned char)32,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            _1_main__load_void_star$left_STA_0$result_STA_0,        _1_main__PlusPI_void_star_unsigned_long2void_star$left_STA_0$result_STA_0$right_STA_1,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)32, 
            ...
            (unsigned char)255,        (unsigned char)255,        _1_main__constant_int$result_STA_0$value_LIT_0,        (unsigned char)64, 
            ...
            (unsigned char)0,        (unsigned char)0,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)16, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__load_int$left_STA_0$result_STA_0, 
            _1_main__constant_int$result_STA_0$value_LIT_0,        (unsigned char)127,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__Gt_int_int2int$right_STA_0$result_STA_0$left_STA_1,        _1_main__branchIfTrue$expr_STA_0$label_LAB_0,        (unsigned char)9, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__goto$label_LAB_0, 
            ...
            (unsigned char)16,        (unsigned char)0,        (unsigned char)0,        (unsigned char)0, 
            _1_main__store_int$left_STA_0$right_STA_1,        _1_main__goto$label_LAB_0,        (unsigned char)30,        (unsigned char)0, 
            (unsigned char)0,        (unsigned char)0,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)16, 
            (unsigned char)0,        (unsigned char)0,        (unsigned char)0,        _1_main__load_int$left_STA_0$result_STA_0, 
            _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)32,        (unsigned char)0,        (unsigned char)0, 
            (unsigned char)0,        _1_main__load_void_star$left_STA_0$result_STA_0,        _1_main__load_char$left_STA_0$result_STA_0,        _1_main__convert_char2int$left_STA_0$result_STA_0, 
            _1_main__Mult_int_int2int$right_STA_0$result_STA_0$left_STA_1,        _1_main__local$result_STA_0$value_LIT_0,        (unsigned char)16,        (unsigned char)0, 
...
char const   *_1_main_$strings  =    "Success!\n\000Sum is: %d\n\000";
...
{ 
  ...
  while (1) {
    ...
    *((void **)(_1_main_$sp[0] + 0)->_void_star) = (_1_main_$sp[0] + -1)->_void_star;
    ...
    break;
    case 1: 
    printf(*((char const   * __restrict  *)(_1_main_$locals + 40)));
    break;
    }
    _1_main_$pc[0] += 4;
    break;
